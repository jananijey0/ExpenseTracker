...
export default function Analysis(props) {
  ...
  // Function to handle custom date range button click
  function handleCustomDateRangeClick() {
    setActive("custom");
    // Implement your custom date range logic here, such as showing a modal or form.
    // For now, we'll just display an alert.
    alert("Custom date range button clicked!");
  }
    ...
    <div className="">
      ...
      <div className="mt-20 w-fit m-auto lg:mb-0">
        <ul className="flex  lg:pb-0 pb-8 lg:px-0 lg:-ml-10 space-x-3 lg:space-x-10">
          ...
          <button onClick={handleCustomDateRangeClick}>
            <li
              className={
                active === "custom"
                  ? "bg-mj-yellow py-3 px-5 rounded-md text-rp-black font-bold"
